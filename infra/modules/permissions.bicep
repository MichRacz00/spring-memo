...
resource kvRole 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(keyVault.id, appName, 'KeyVaultSecretsUser')
  scope: keyVault
  properties: {
...
resource configRole 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(appConfig.id, appName, 'AppConfigurationDataReader')
  scope: appConfig
  properties: {
...
resource storageRole 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(storage.id, appName, 'StorageBlobDataContributor')
  scope: storage
  properties: {
